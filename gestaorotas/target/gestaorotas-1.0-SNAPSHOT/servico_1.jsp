...
<head>
    ...
    <title>Servicos - Taxi Service</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp">Ini­cio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="sobre.jsp">Sobre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="servico.jsp">Servicos</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            ...
            <p class="lead">Oferecemos uma gama de servicos de transporte para atender todas as suas necessidades.</p>
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Taxi Rapido</h5>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Taxi Confortavel</h5>
                            <p class="card-text">Desfrute de conforto e seguranca nos nossos vei­culos bem equipados.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nossos motoristas sao profissionais e capacitados para lhe atender.</p>
                        </div>
                    </div>
                </div>
            </div>
